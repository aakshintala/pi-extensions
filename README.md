...
| [stamp](extensions/stamp/README.md) | Timestamps, response timing, metadata and tool durations in the transcript; no row for tool-only responses by default | [#36](https://github.com/aakshintala/pi-rig/issues/36) |
